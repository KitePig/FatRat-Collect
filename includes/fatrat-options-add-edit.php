        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" size="6" value="<?php echo isset($option) ? $rule_link['a'] : 'link'; ?>" disabled name="collect_list_rule_link_a" />-<input type="text" size="20" value="<?php echo isset($option) ? $rule_link['b'] : ''; ?>" name="collect_list_rule_link_b" />-<input type="text" size="4" value="<?php echo isset($option) ? $rule_link['c'] : ''; ?>" name="collect_list_rule_link_c" />-<input type="text" size="40" value="<?php echo isset($option) ? $rule_link['d'] : ''; ?>" name="collect_list_rule_link_d" />*
                </td>
            </tr>
            <tr>
                <th>详情页面采集区域:</th>
            ...
            <tr>
                ...
                <td>
                    &nbsp;&nbsp;&nbsp;规则名&nbsp;&nbsp;- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;JQuery选择器 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;- &nbsp;属性 &nbsp; - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;标签过滤&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.querylist.cc/docs/guide/v4/scraper-list" target='_blank'>必填规则参考</a><br />
                    <input type="text" size="6" value="<?php echo isset($rule_title['a']) ? $rule_title['a'] : 'title'; ?>" disabled name="collect_content_rule_title_a" />-<input type="text" size="20" value="<?php echo isset($rule_title['b']) ? $rule_title['b'] : ''; ?>" name="collect_content_rule_title_b" />-<input type="text" size="4" value="<?php echo isset($rule_title['c']) ? $rule_title['c'] : ''; ?>" name="collect_content_rule_title_c" />-<input type="text" size="40" value="<?php echo isset($rule_title['d']) ? $rule_title['d'] : ''; ?>" name="collect_content_rule_title_d" />*
                    <br />
                    <input type="text" size="6" value="<?php echo isset($rule_content['a']) ? $rule_content['a'] : 'content'; ?>" disabled name="collect_content_rule_content_a" />-<input type="text" size="20" value="<?php echo isset($rule_content['b']) ? $rule_content['b'] : ''; ?>" name="collect_content_rule_content_b" />-<input type="text" size="4" value="<?php echo isset($rule_content['c']) ? $rule_content['c'] : ''; ?>" name="collect_content_rule_content_c" />-<input type="text" size="40" value="<?php echo isset($rule_content['d']) ? $rule_content['d'] : ''; ?>" name="collect_content_rule_content_d" />*
                </td>
            </tr>
<!--            <tr>-->
<!--                <th>采集内容的规则:</th>-->
